//references : https://www.techiedelight.com/graph-implementation-c-without-using-stl/
#include <iostream>
using namespace std;
...
void countNeighbour(Node* ptr)
{
    ...
    cout << "Total number of neighbour: " << count;
    cout << endl;
}
